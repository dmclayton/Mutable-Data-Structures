...
these structures often prove rigurous bounds on how much error can be expected,
...
structures in adversarial environments. Our synatx is applicable to a wide
