...
%
\todo{DC}{Double check this. Sometimes, cryptographers and non-cryptographers
will use the term ``keyed (cryptographic) hash function'' instead of ``PRF'',
but ``cryptographic hash function'' doesn't mean the same thing as ``keyed
