...
comparable for $\ell=nk$; however, when we take into account the factor
of~$q_R$, the bound for thresholding is much better than what we are able to
prove for capping.
...
\begin{figure}
  ...
  \caption{
    ...
    Theorem~\ref{thm:sbf-erreps-th} for $\ell=nk$.
  }
  \label{fig:bf-th}
\end{figure}
