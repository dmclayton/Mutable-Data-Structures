...
\begin{figure}
  ...
  $\hw$ is the Hamming weight and $\bmap_m$ is the bitmap function taking a list
  of indices in $[m]$ and producing the string of length $m$ where exactly those
  bits are set to 1.}
  \label{fig:bf-def}
\end{figure}

he formal Bloom filter construction is given in~\ref{fig:bf-def}. From this
