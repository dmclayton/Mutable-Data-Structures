...
\begin{figure}
  ...
  {
    \vspace{-7.5pt}
    \experimentv{$\game_0(\advA)$}
                  \hfill\diffplus{$\game_1$}\;\diffminus{$\game_0$}\\[2pt]
    ...
    \\[2pt]
    \oraclev{$\REPO(\col)$}
                            \hfill\diffplus{$\game_2$}\;\diffminus{$\game_1$}\hspace*{0pt}\\[2pt]
      $\ct \gets \ct + 1$; $\err_\ct \gets 0$;
      $\col_\ct \gets \col$\\
  ...
  }
  {
    \vspace{-7.5pt}
    \oraclev{$\REPO(\col)$}
                    \hfill\diffplus{$\game_3$}\;\diffminus{$\game_2$}\hspace*{0pt}\\[2pt]
      $\ct \gets \ct + 1$; $\err_\ct \gets 0$;
      $\col_\ct \gets \col$\\
    ...
    \hspace*{-4pt}\rule{1.049\textwidth}{.4pt}
    \\[2pt]
    \oraclev{$\QRYO(i, \qry_x)$},\hfill\diffplus{$\game_5$}\;{$\game_4$}\hspace*{0pt}\\[2pt]
      $\ct' \gets \ct' + 1$\\
      \foreach{j}{1}{\ct}\\
      \tab $a_j \gets \Qryx[\Rnd](\pub_j, \qry)$\\
