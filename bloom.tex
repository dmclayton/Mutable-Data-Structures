...
updated to include each new page the crawler visits \todo{DC}{Need citation}.
...
%
\cpnote{This is very interesting! Is it your idea? If not, then you need to cite
the source.}

\heading{Pollution attacks}
%
\todo{DC}{Ensure that we've mentioned Gerbet \etal in the intro or related work,
or give more context for the paper here. In 1-2 sentences, what did it aim to
do?}
%
...
insertions.
%
\cpnote{Is there attack for a particular choice of~$H$ or does it work
regardless of the choice of~$H$, as long as it's known to the attacker?}

\cpnote{Not sure what this adds, or if it's necessary.}
...
representations are observed by the adversary. The $q_H/2^\lambda$ term
...
the \errep1 setting is quite realistic, since the attack can be carried out
offline.
%
