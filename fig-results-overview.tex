...
\caption{Summary of results.  An entry of `\xmark' means there is a
  ...
  An entry of `\secres{$nn$}' means that we
  explicitly prove a security bound for the structure in Theorem $nn$. 
  An entry of `\cmark'  means that the structure is secure, but we do
  not give an explicit result in this submission.}
