...
\small
  \begin{tabular}{ |p{5cm} | p{10cm}|}
    ...
    \parbox[c][2.4cm]{5cm}{Bloom\;filter\\(Fig.~\ref{fig:bf-def}, Fig.~\ref{fig:bft-def})}
          & \parbox[c][2cm]{10cm}{Traditional implementation
    ...
    \parbox[c]{5cm}{Counting filter (Fig.~\ref{fig:cbf-def})}
          & \parbox[c][1.6cm]{10cm}{Traditional implementation insecure.\\Security can be achieved by combining a per-representation salt, thresholding, and private representations.}
         \\ \hline
