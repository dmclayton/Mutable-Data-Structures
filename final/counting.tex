...
allow for deletion as well as insertion~\cite{fan2000summary}. Like ordinary
...
$\ell$-thresholdedversion of this structure. The traditional description of
...
of Theorem~\ref{thm:scms-erreps-th} for count min-sketches.
