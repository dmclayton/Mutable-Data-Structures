...
\todo{DC}{Make this about counting filters}
...
\todo{TS}{Have another look at the results in Sections 5 and 6. The error
function for CMS is now simply ``was the response an overestimate''; the
counting filter is the one that allows for weighting false positives and
