...
change over time, e.g., streaming data applications. Several data structures are
designed to natively support \emph{mutable} representations, such as the
counting filter~\cite{fan2000summary}, count-min
