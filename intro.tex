...
error capacity.
%
In th \errep\ game, the adversary is given the representation of a chosen set
...
%
The \erreps\ game is defined in much the same way, except that represntations
...
but for many of the structures we analyze here, security is only achievalbe in
the \erreps\ setting.
%
