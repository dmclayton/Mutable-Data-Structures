...
filters~\cite{fan200summary} (Section~\ref{sec:count}). Each of these supports
...
in our setting \emph{as they are usually deployed}. In particular, each of these
structures is susceptible to a class of attacks we call \emph{target-set
coverage attacks}, described in Section~\ref{sec:bad-bfs}.
