...
\todo{DC}{No need to describe these, as they will definitely appear above.
Describe our results, one sentence per theorem and one sentence per attack.}

\heading{Count min-sketches}
\todo{DC}{Give a high level overview of this structure, since it may not appear
above. Then give our main result. What's different here? What did we learn}

\heading{Counting filters}
\todo{DC}{Give a high level overview of this structure. Then give our main
result. What's different here? What did we learn}
