...
perspective.
%
\todo{DC}{Exhibit adversary~$D$ such that $\Prob{\game_0(\advA)=1} -
\Prob{\game_1(\advA)=1} \leq \Adv{\prf}_F(D)$, and argue that its resoruce are
as stated by the theorem. You don't need to be super formal about it, but you do
need to say how~$D$ executes~$\advA$ and what outputs.}
