...
%
\cpnote{The above argument is rather long, and It might be easier to make itby
giving an explicit reduction. Given that 1 and 2 are as dfined, if there's an
adversry $\advB$ thqat's good at game 1, how do you build an adversary~$\advC$
from~$\advB$ that gets at least as much advantage in game 2 as~$\advB$ does in
game 1?}
...
elements. So we have, analagously to the previous theorem\todo{DC}{fix ref},
\begin{equation}
