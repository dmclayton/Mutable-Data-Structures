...
\begin{center}
  \begin{tabular}{ | c | c | c | c | c | }
    ...
    1 & 0 & 0 & 1 & Attack 3, Theorem 1 \\ \hline
    1 & 0 & 1 & 0 & ? \\ \hline
    1 & 0 & 1 & 1 & ? \\ \hline
...
By Lemma~\ref{lemma:errep} we have $\Adv{\errep}_{\struct,r}(t, q_R, q_T, q_U, q_H) \leq q_R\cdot\Adv{\errep1}_{\struct,r}(O(f(t)), q_T, q_U, q_H)$ where $f(t) = t + (q_R-1)\ticks(\Rep,t) + q_T\ticks(\Qry,t) + q_U\ticks(\Up,t)$, so we consider $\errep1$ adversaries.
