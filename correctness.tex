...
If the adversary cannot guess representations but can predict query responses given representations, there are still limits on how secure the structure can be.

%

Finally, if both representations and queries are unpredictable by the adversary, we would like to say that the adversary cannot do any better than the non-adaptive case