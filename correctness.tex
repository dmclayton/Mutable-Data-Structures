...
%
\cpnote{This isn't true right now, since $setC_i$ is \textbf{undefined}.}
%
...
\cpnote{\bf undefined}  is used to prevent (WLOG) the adversary from repeating a
...
\cpnote{\bf undefined} is reset to empty, because the data object~$\col_i$ is
``new'' again.
%
...
\todo{DC}{Define the $\Adv{\errep1}_{\struct,\delta,r}(\cdots)$ advantage function.}
