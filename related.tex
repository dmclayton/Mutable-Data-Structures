\paragraph{Comparison with Naor and Yogev.}
...
\begin{itemize}
  ...
  \item Naor and Yogev analyze the correctness of a new Bloom filter variant of
    ...
    existing, real-world constructions to understand their security.
      \if{0}{
        In particular, we analyze the most-common case of Bloom filters in the
        random-oracle model, something not considered by Naor and~Yogev.
      }\fi
\end{itemize}
...
%
\jnote{History-independent data structures seem relevant to mention.}
\cpnote{What does this mean?}
